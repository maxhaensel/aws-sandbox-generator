...
class AWSSandBoxHosting(cdk.Construct):
    def __init__(
        self, scope: cdk.Construct, construct_id: str, *, ssm_sandbox_domain_uri: ssm.StringParameter
    ) -> None:
        ...
        ssm_sandbox_hosting_bucket_name = ssm.StringParameter(
            ...
            parameter_name="sandboxHostingBucketName",
